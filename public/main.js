    ...
    try {
        ...
        switch (jsonMessage.action) {
            ...
            case "ideCandidate":
                ...
                break;
            default: console.log('unknown action', jsonMessage.action);
        }
    } catch (error) {
...
const getLocalMediaStream = async () => {
    try {
        ...
        console.log('got local media stream', mediaStream);
...
const initializePeerConnection = async (mediaTracks) => {
    ...
    peerConnection.onicecandidate = ({ candidate }) => {
        ...
        console.log('iceCandidate', { remoteId, candidate});
    };
...
const startVGA = () =>
  getMedia({ video: { width: 640, height: 480 }, audio: true });
